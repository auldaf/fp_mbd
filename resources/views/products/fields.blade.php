...
<div class="form-group col-sm-6">
    {!! Form::label('product_image', 'Product Image:') !!}
    {!! Form::file('product_image', ['class' => 'form-control-file', 'id' => 'product_image']) !!}
    @if(isset($products) && $products->product_image)
        @if(isset($products) && $products->product_image)
            <img src="data:{{ $products->product_image }};base64,{{ base64_encode($products->product_image) }}"
